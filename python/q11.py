...
"""
The theory is that for a particular (x,y) we only actually need to check 4 non-parallel of the 8 directions (N, NE, E, SE, S, SW, W, NW)
     NW  N  NE
      \  |  /
       \ | /
   W---(x,y)---E
...
E.g. at (5,7) NW would have already been covered by SE at (2,4)
"""
